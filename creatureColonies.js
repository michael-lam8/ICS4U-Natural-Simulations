// Michael Lam
// April 7, 2019
// Particle Systems: Creature Colonies

// Declaring variables
var accel = random(0.001, 0.005), negAccel = random(-0.001, -0.005), boundary = 150;
var blueHue = 135, time = 0, counterRunning, fish = [], fishBorn = false;
...
// Sets Fish object
var Fish = function(bodyColour, bodyLength, bodyHeight, tailWidth,
    ...
    this.acceleration = new PVector(accel, accel);
};
